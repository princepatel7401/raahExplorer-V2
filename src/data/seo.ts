/** Canonical site URL — update if your live domain differs */
export const SITE_URL = "https://www.raahexplorer.com";
...
export const seoDefaults = {
  ...
  keywords: [
    "Raah Explorer",
    "Raah Explorer Ahmedabad",
    "tour packages Ahmedabad",
    "travel packages Ahmedabad",
    "Ahmedabad tour operator",
    "travel agency Ahmedabad",
    "Gujarat tour packages",
    "domestic tour packages",
    "international travel packages",
    "honeymoon packages Ahmedabad",
    "private tours",
    "group tours",
    "hotel flight train bus booking",
    "Thaltej travel agency",
  ].join(", "),
} as const;
